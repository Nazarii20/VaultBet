...
export class CrashEngine {
  public static CrashSpeed = 0.00006; // represents the rate at which the crash multiplier increases.
  public static PredictingLapse = 300; //specifies the duration (in milliseconds) before the engine predicts a possible lag.

  public startTime = 0;
  public elapsedTime = 50;
  ...
  public getElapsedPosition(elapsedTime: number) {
    ...
    return {
      x: elapsedTime > 0 ? (elapsedTime * this.xIncrement) : 50,
